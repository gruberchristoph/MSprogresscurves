...
reactant_masses = [overview_info_A(Eidx-1,find(strcmp(overview_info_B(1,:),"S1-m/z"))) overview_info_A(Eidx-1,find(strcmp(overview_info_B(1,:),"S2-m/z"))) overview_info_A(Eidx-1,find(strcmp(overview_info_B(1,:),"P1-m/z"))) overview_info_A(Eidx-1,find(strcmp(overview_info_B(1,:),"P2-m/z")))];
reactant_abbrev = string([overview_info_B(Eidx,find(strcmp(overview_info_B(1,:),"reactants-1"))) overview_info_B(Eidx,find(strcmp(overview_info_B(1,:),"reactants-2"))) overview_info_B(Eidx,find(strcmp(overview_info_B(1,:),"reactants-3"))) overview_info_B(Eidx,find(strcmp(overview_info_B(1,:),"reactants-4")))]);
precip_strong = string(overview_info_B(Eidx,find(strcmp(string(overview_info_B(1,:)),"precipitation_strong"))));
precip_weak = string(overview_info_B(Eidx,find(strcmp(string(overview_info_B(1,:)),"precipitation_weak"))));
%
