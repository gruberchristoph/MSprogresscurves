...
enzyme_name = ["Ppc"]; % enzyme name corresponding to CODETABLES.xlsx - overview sheet
...
fiadata_scores = FUNCTION_ProgressCurveScreen_barplot_translated_bootstrap(analysis_path,fiadata_effs, enzymelabel, ions_excl,r2_threshold,AUC2ac,fit_function,bypass_AUC,split_on,excl_if_r2_lower_than_08_of_max,transl_mode,lnACT_on,plot_only_relevant,save_all_results)
